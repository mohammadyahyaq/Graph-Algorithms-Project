...
public class Heap {
    ...
    public boolean insert(Vertex key) { // Give me Vertex object, not char :D 
    ...
    public void trickleUp (int index) {
        ...
        while (index > 0 && heap[parentIndex].label > temp.label){
    ...
    public Vertex remove(Vertex key) {
    ...
    public void trickleDown (int index){
        ...
        while(index < currentIndex/2){//While the Vertex has at least one child 
            ...
            if (rightChild < currentIndex && heap[leftChild].label > heap[rightChild].label)
            ...
            if (temp.label < heap[largerChild].label ) 
                break;
